...
* **📜 Rapport d'Étude :**
- [cite_start][Télécharger le Rapport de Modélisation (PDF)](Optique_par_lancer_de_rayons.pdf) [cite: 3]
* **💻 Code Source :**
  - [cite_start][Consulter le Script Python de Simulation](Script_optique_par_lancer.py) [cite: 179]
